...
# Hi, I'm Bhuvaneshwari L 👋

**Aspiring Data Analyst | SQL · Power BI · Excel · Python · Cloud**

📊 Turning raw data into real, actionable decisions — dashboards, insights, and reporting.
...
|---|---|---|
| [Margin Console: Diagnosing Profit Leaks in Quick-Commerce](https://github.com/bhuvaneshwari-99/Quick-Commerce-Profitability-Optimizer) | Identified a ₹4.4M net loss driven by 40% discount penetration and pinpointed 3 cities responsible for 41% of total losses — enabling the business to cut discounting in low-margin cities and reallocate spend to profitable ones. Analysis pipeline: PostgreSQL → Excel → Power BI on 1M+ quick-commerce orders. | SQL, Python, Power BI |
...
- 🧩 **HackerRank:** [1ep22ec019](https://www.hackerrank.com/profile/1ep22ec019)
- 🧠 **LeetCode:** [kokwvxtnma](https://leetcode.com/u/kokwvxtnma/)
- 🌱 **HackerEarth:** [1ep22ec019](https://www.hackerearth.com/@1ep22ec019)
...
- Building a strong foundation in SQL, Python, and Power BI for real-world data analysis
- Seeking opportunities as a **Data Analyst** or **Business Analyst** to apply analytical and visualization skills
- Interested in turning messy, raw datasets into clear dashboards and business insights
- Growing toward advanced analytics, forecasting, and data storytelling
...
- 🌱 Actively learning and building in the data analytics space
- 📌 Bookmarked repos covering SQL, Power BI, and data visualization practice
- 🧠 Practicing problem solving on HackerRank, LeetCode, and GeeksforGeeks
- 🚀 Currently focused on shipping polished, portfolio-ready analytics projects
